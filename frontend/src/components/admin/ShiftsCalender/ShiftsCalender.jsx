...
const ShiftsCalender = ({userObj}) => {
  ...
  function settingshiftinbackend () {
    ...
    axios.put("/user/updatingshift" , {id: idhere._id , shiftid:editshift12 })
    .then(() =>{
  ...
  const handleEventClick1 = (event) => {
    ...
    axios
            .get(
              "shift/findCurrentShiftNotification/" +
                currentId +
                "/" +
                oneEvent._id
            )
  ...
  function onChange(date, dateString) {
    ...
    console.log(currentId);
    axios
      .get("shift/specificDateShifts/" + dateString + "/" + currentId)
      .then((res) => {
...
const prepassnotification = () => {
  ...
  axios.put("/user/updatingshift" , {id: oneEvent._id , shiftid:id21 })
  .then(() =>{
     passNotification();
    console.log("update ho gai")
  })
  ...
  const passNotificationforr = () => {
    ...
    let date = new Date().toISOString().slice(0, 10);
    const message =
      "One of the User wants to swap his shift with you. Click for the details";
    const requester = "Admin";
    const currentUserId = currentId;
        ...
        >
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-6"><Button onClick={() => seteditshift(true)} key="1" danger type="primary" >
                  Edit
                </Button></div>
              <div className="col-3">
      ...
      <Modal
        ...
        footer={[
          <Button
            type="primary"
            key="1"
            onClick={() => setFailexchangeVisible(false)}
          >
            Cancel
          </Button>,
        ]}
...
<Modal
          title="Admin Edit Shift"
          visible={editshift}
          maskClosable={true}
          onCancel={() => seteditshift(false)}
          onOk={settingshiftinbackend}
        >
          <div>
              ...
              <div>
                <Card type="inner">
                  ...
                  <div className="row">
                    ...
                    <div className="col-6">
                      <Select
                        defaultValue={oneEvent.shiftname}
                        style={{ width: 280 }}
                        onChange={handelFrom1}
                      >
                        {data.map((dat) => (
                          <Option value={dat._id} key={dat._id}>
                            {dat.shiftname}
                ...
                <div className="row">
                  ...
                  <div className="col-5"></div>
                  <div className="col-2">
                    <Button onClick={() => setexchangeVisible(false)}>
                      Cancel
                    </Button>
                  </div>
                  <div className="col-2">
