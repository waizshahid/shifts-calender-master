...
const ShiftsCalender = () => {
	...
	useEffect(() => {
		console.log(currentShift);
		axios
			.get('user/getEventHistory/' + currentShift)
			.then((res) => {
				console.log(res.data.shifts);
	...
	return (
		<div className='m-sm-4 m-2'>
			<div className='row'>
				...
				<div className='col-3'>
					<select id='selectDoctor' name='cars' className='custom-select bg-light m-2 shadow-sm' onChange={filterShift}>
						...
						<option value='Shifts Only'>Shifts Only</option>
          ...
          <div className="col-4"> */}
			...
			<Modal title='Update Shift' visible={updateVisible} maskClosable={true} onCancel={() => setupdateVisible(false)} footer={null}>
