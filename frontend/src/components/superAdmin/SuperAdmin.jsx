    ...
    <div>
            ...
            <Sider style={{ height: "100vh" }}>
              ...
              <Menu theme="dark" mode="inline" defaultSelectedKeys={[]}>
                ...
                <Menu.Item key="3" icon={<FormOutlined />}>
                  <Link to="/superadmin/manage-shift-types">
                    Manage Shift Types
                  </Link>
                </Menu.Item>
                ...
                <Menu.Item key="9" icon={<PullRequestOutlined />}>
                  <Link to="/superadmin/manage-requestShifts">
                    Requested Shifts
                  </Link>
                </Menu.Item>
      ...
      >
        ...
        <Switch>
          ...
          <Route
            exact
            path="/superadmin/shifts-calender"
            component={ShiftsCalender}
          />
          <Route
            exact
            path="/superadmin/manage-shift-types"
            component={ManageShiftTypes}
          />
          <Route
            exact
          ...
          <Route
            exact
            path="/superadmin/manage-requestShifts"
          ...
          <Route
            exact
            path="/superadmin/exchange-shifts"
