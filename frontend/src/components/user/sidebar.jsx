...
const Side = ({ user }) => {
  ...
  const showShiftModal1 = (message) => {
    ...
    axios.get("user/getShiftTo/" + dsplayMessage[message].to).then((res1) => {
                ...
                <div>
                  {
                    message.requesterType === 'Admin' ?
                     <div> {  message.message !== "Your shift has been exchanged. View Details" &&  message.message !=="Your rejection response has been sent to the swap requester" ? 
                     <div>
                        <div className="row">
                         <div onClick={() =>showShiftModal1(index)}><Tag color="red">{'Detail'}</Tag></div>
                          <div className="col-4">
                        ...
                        <div className="row">
                          <div className="col-12">
                            {message.message}
                              ...
                              <Button onClick={() =>updateNotification1(index)} className="rejectbutton" >Reject</Button>
                              <Button type="primary" className="button2setting" onClick={()=>swapShift1(index)}>Exchange</Button>
                              </Row>
                              <hr />
                      </div>:<div>
                        <div>
                      ...
                      <div>
                        {
                          message.from === currentId ?
                            <div>
                             ...
                             <div>
                               <div className="row">
                               <div onClick={() =>showShiftModal1(index)}  className="col-2"><Tag color="red">{'Detail'}</Tag></div> 
                                <div className="col-4"><Tag color="green">{users[index].firstName + ' ' + users[index].lastName}</Tag></div>
                                <div className="col-6"><Tag color="default">{message.shiftName}</Tag><Tag color="default">{message.regDate}</Tag></div>
                               </div>
                              <div  className="row">
                             ...
                             <Button  onClick={() =>deleteNotification1(index)}>Delete this notification</Button>
                              ...
                              <br></br>
                              <div className="row">
                              <Button className="col-6"  onClick={() =>deleteNotification1(index)}>Delete this notification</Button>
                              <div className="col-6" onClick={() =>showShiftModal1(index)}><Tag color="red">{'Detail'}</Tag></div>
                              </div>
                            </div><hr /></div>
                              }
                            </div>
